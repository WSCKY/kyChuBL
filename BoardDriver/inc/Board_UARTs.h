/**
  ...
  * @brief   Header file for Board UART Driver.
  ******************************************************************************
*/

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __BOARD_UARTS_H
#define __BOARD_UARTS_H
...
#define UART8_ENABLE                             (1)
  ...
  #define UART7_RX_DMA_ENABLE                    (1)
#endif /* UART7_ENABLE */
#if (UART8_ENABLE)
  #define UART8_TX_DMA_ENABLE                    (1)
  #define UART8_RX_DMA_ENABLE                    (1)
#endif /* UART8_ENABLE */
/* Exported macros -----------------------------------------------------------*/
#if (UART7_ENABLE)
